...
* add support for structured output ([837a0e0](https://github.com/Aleph-Alpha/pharia-engine/commit/837a0e0f9033f2b18bad5f40fe26d2ceae660ace))
* add target and context to error messages ([745b1e4](https://github.com/Aleph-Alpha/pharia-engine/commit/745b1e4de144a26249faa790c81b72d3e4297104))
* add tool call hardcoded skill ([3798d13](https://github.com/Aleph-Alpha/pharia-engine/commit/3798d13f667db2daceadb653b6f55283b4771566))
* add warning if running without inference capabilities ([d9061cc](https://github.com/Aleph-Alpha/pharia-engine/commit/d9061cc85d0d58218c5b802fd89e348e97d32586))
* Allow configuring native_tools, no computing of diffs yet ([a158e3a](https://github.com/Aleph-Alpha/pharia-engine/commit/a158e3a45505824753a2adc8558e542a8c27ccb2))
* allow running without requiring bearer token ([5ab0e9b](https://github.com/Aleph-Alpha/pharia-engine/commit/5ab0e9b45b36bc6e789a3465ba8b3c761a432b26))
...
* authorization client decides if no token is okay ([75c900a](https://github.com/Aleph-Alpha/pharia-engine/commit/75c900a909f8a1293c573aef92ddceee7b6aca7f))
* better error message on model not found ([56d2de2](https://github.com/Aleph-Alpha/pharia-engine/commit/56d2de214b08a0831afb86d4bcb2bbe547aea9e8))
* better error msg for 404 mcp server result ([b23ff38](https://github.com/Aleph-Alpha/pharia-engine/commit/b23ff38d2d047dd381a0641c8cb5791b1396cb35))
* chunk text based on characters if tokenizer not available ([8b23e44](https://github.com/Aleph-Alpha/pharia-engine/commit/8b23e4400efaedbdb37c9bf8d11d0f7bc2731195))
* custom logs without span context and attributes ([268cd96](https://github.com/Aleph-Alpha/pharia-engine/commit/268cd962a3148b16d84a359a5c315f3444ec07c7))
* do not specify a namespace in default config.toml ([b6105c8](https://github.com/Aleph-Alpha/pharia-engine/commit/b6105c8ee42c74b480082fa676c2bbb7274dd34d))
* document index is an optional dependency ([8a7ea86](https://github.com/Aleph-Alpha/pharia-engine/commit/8a7ea8629b76047a0bc0878e084ee58009e6a725))
* expose 0.4 tool call params via csi shell ([0d6f471](https://github.com/Aleph-Alpha/pharia-engine/commit/0d6f471055a04ebcdb2fbd81c270248cb44d4fd8))
* expose list tools in wit world ([2e26361](https://github.com/Aleph-Alpha/pharia-engine/commit/2e263612d15946a2035cd2bde88f020005cb01b5))
* expose list tools via csi shell ([72d5736](https://github.com/Aleph-Alpha/pharia-engine/commit/72d573636f4defa7fd18bca1378d8c2c655c93b7))
* expose tool errors in the wit world ([8285a9a](https://github.com/Aleph-Alpha/pharia-engine/commit/8285a9a58dbf24f2dc1c16a7f60507ea65d7548c))
* expose tool invocation errors in message stream ([c907e28](https://github.com/Aleph-Alpha/pharia-engine/commit/c907e284cc2060205771bab5e0c1be4aa19ecc7d))
...
* fetch native tools ([f82d0b0](https://github.com/Aleph-Alpha/pharia-engine/commit/f82d0b00660dd345f040fab1cb7d8f84f42044d0))
* implement invoke for native tool ([4b63024](https://github.com/Aleph-Alpha/pharia-engine/commit/4b6302467d5e5fb46f87eef9d69089e1b4c4f6e2))
* implement openai client ([40cf128](https://github.com/Aleph-Alpha/pharia-engine/commit/40cf1288cbac985a7c93fcef375d6fd263e2d7c8))
* improve error logging ([d5e7e79](https://github.com/Aleph-Alpha/pharia-engine/commit/d5e7e79d64e69c594812c8ec0b94e5678f27230f))
* include environment variable name in error message ([97ea9fa](https://github.com/Aleph-Alpha/pharia-engine/commit/97ea9faebfe2c6aff5a94605fd2b67c8563e0c75))
* include error in logs when skill execution fails ([1d6e7cb](https://github.com/Aleph-Alpha/pharia-engine/commit/1d6e7cbe850c55b2e6626423f67dcd34eafd0f71))
* include reasoning-effort in chat-params ([e7a806e](https://github.com/Aleph-Alpha/pharia-engine/commit/e7a806e613ae3d038af70a71420150aa65559ea9))
* increase http body limit to 50mb ([b93bbab](https://github.com/Aleph-Alpha/pharia-engine/commit/b93bbab1d098e91384d405cd8633c5ecdebacf38))
* inference url is optional in app config ([a62f135](https://github.com/Aleph-Alpha/pharia-engine/commit/a62f135dee63b5b48c6f0f1c1f3b9b6c19ed7574))
...
* introduce 0.4 wit world ([8aec913](https://github.com/Aleph-Alpha/pharia-engine/commit/8aec913d22a318d5139dd7dc13223c539cc7792f))
* introduce native tool saboteur ([5cd0cf6](https://github.com/Aleph-Alpha/pharia-engine/commit/5cd0cf6f0b35ac92aac75ff143a5657ad95ca5b0))
...
* list hardcoded native tools in test-beta namespace ([df7ef5f](https://github.com/Aleph-Alpha/pharia-engine/commit/df7ef5f33e2faf90c623f0b2d029038c1e266a5b))
* list native tools ([a5737c8](https://github.com/Aleph-Alpha/pharia-engine/commit/a5737c80963e7dcdd43fe008bf9255eb61e843a9))
* log error if 401/403 when accessing registry ([0a065d2](https://github.com/Aleph-Alpha/pharia-engine/commit/0a065d280e2b12d8fd655262eddcb7606be5de03))
* log invalid input ([b01ecb0](https://github.com/Aleph-Alpha/pharia-engine/commit/b01ecb029290c5bcdbfebdc125e04db2cb773b30))
* log skill loading errors ([d9c70ca](https://github.com/Aleph-Alpha/pharia-engine/commit/d9c70ca464667d5753263194f4264e7ab0d4e0a8))
* make authorization check optional ([bbf7f08](https://github.com/Aleph-Alpha/pharia-engine/commit/bbf7f08cf5cf85361284c14bbb2da9bd13daa678))
* make base_repository optional ([aa943a4](https://github.com/Aleph-Alpha/pharia-engine/commit/aa943a4b871edd56d4daf732e7c98894d16e4fa0))
* map empty document index url to none in app config ([858df5c](https://github.com/Aleph-Alpha/pharia-engine/commit/858df5cb450795874523d129770d6bb68829ae74))
* mark 0.4 wit world as unstable ([553e139](https://github.com/Aleph-Alpha/pharia-engine/commit/553e139a253e0480f7ae1da844fa2cbc0e4ffaf6))
* Mcp Actor keeps an up to date tool list and informs tool runtime ([bac24e8](https://github.com/Aleph-Alpha/pharia-engine/commit/bac24e8a65e31f30ce21cd961ebbb193d52ef7f0))
...
* migrate to check_user iam endpoint ([33697f3](https://github.com/Aleph-Alpha/pharia-engine/commit/33697f389c9a82b9931e6c3ae51f70284d90b19d))
* no need to fail on events without content or tool call ([bc9c1c9](https://github.com/Aleph-Alpha/pharia-engine/commit/bc9c1c9bfa72b4b7f73a6c3b9b3ccb81ceb7cecf))
* offer tool description via tool routes ([d77d20f](https://github.com/Aleph-Alpha/pharia-engine/commit/d77d20f8cc90f7a37bba0755618909727336c77a))
* openAI inference backend can be configured ([e99d410](https://github.com/Aleph-Alpha/pharia-engine/commit/e99d4108236bd92b985c24d77e791aacd26f9fd5))
...
* order mcp servers by name when listing ([943dc4d](https://github.com/Aleph-Alpha/pharia-engine/commit/943dc4d9bd8258e23ea3fe0d8a1ea36947853ba7))
* pass tool errors to skills ([9edb767](https://github.com/Aleph-Alpha/pharia-engine/commit/9edb7677e7ba290fd7ce514c8a9f415c1b74a954))
* print causes for error fetching namespace description ([4e67ee7](https://github.com/Aleph-Alpha/pharia-engine/commit/4e67ee761c3d0a949f09fe2320674f876e3427ce))
* promote list_mcp_servers and list_tools routes ([54311ba](https://github.com/Aleph-Alpha/pharia-engine/commit/54311ba53ca97a47ede73c3b8d99ea53ee34803e))
* propagate tool call to 0.4 wit world ([ea36ac0](https://github.com/Aleph-Alpha/pharia-engine/commit/ea36ac0f3928a8068d782fb4615fc58409db0d55))
...
* remove beta flag from configuration parsing ([1426390](https://github.com/Aleph-Alpha/pharia-engine/commit/142639035fed58156c9c5fffa7a7387b5f264804))
* remove content from tool stream event ([d530f7f](https://github.com/Aleph-Alpha/pharia-engine/commit/d530f7fad75486dacd75b4ded44b2bec958920d1))
* remove explain functionality in 0.4 wit world ([57c3ec0](https://github.com/Aleph-Alpha/pharia-engine/commit/57c3ec068dca1e9aa52ac81c231f14295825e53f))
...
* report tool output in stream ([b118c9c](https://github.com/Aleph-Alpha/pharia-engine/commit/b118c9c2bdddca3c6a2279890151da33a4ac2793))
* Respect OS certificate store for outgoing http requests ([d3b757b](https://github.com/Aleph-Alpha/pharia-engine/commit/d3b757b15e92be0dc192c4f29909065eaf9cebc3))
* return 401 instead of 400 when no token is provided ([1615a76](https://github.com/Aleph-Alpha/pharia-engine/commit/1615a76853aad85ab65c8b045531ec97bd9f17aa))
* skill context emits tool call event ([46e3c49](https://github.com/Aleph-Alpha/pharia-engine/commit/46e3c49069d2a09b1566219857642378c411a266))
* skill driver forwards skill ctx event ([9ea981e](https://github.com/Aleph-Alpha/pharia-engine/commit/9ea981e6f6256311c8e2408b35b87f728d7e2e0e))
...
* stablize tool interface as wit package version v0.3.11 ([0ae6f54](https://github.com/Aleph-Alpha/pharia-engine/commit/0ae6f54c9d8c210278f535111bf444f305fd4aec))
...
* support Minimal variant of ReasoningEffort ([67a16fc](https://github.com/Aleph-Alpha/pharia-engine/commit/67a16fc49d9c9fe9128587f024a7dbacc5b0dbe5))
* support parallel-tool-call parameter in 0.4 wit world ([8784cc7](https://github.com/Aleph-Alpha/pharia-engine/commit/8784cc71c967d07539763efa7294d523de295141))
* support tool call stream events in 0.4 wit world ([bbe7118](https://github.com/Aleph-Alpha/pharia-engine/commit/bbe71186150f3501d4e5b33089e7e328bfe43bbe))
* support tool-choice parameter in 0.4 wit world ([50d0505](https://github.com/Aleph-Alpha/pharia-engine/commit/50d050577479e09381a4209f20ce40f776dd77c3))
* tool begin event serialized via routes ([b22d354](https://github.com/Aleph-Alpha/pharia-engine/commit/b22d354e9d028513a3e3ab2f8e99021d789091cb))
* tool end events are exposed via routes ([22bec69](https://github.com/Aleph-Alpha/pharia-engine/commit/22bec696f2771af2865ca93b890b42cb055f30bc))
* tool invocation errors are part of csi shell body ([32e9cc3](https://github.com/Aleph-Alpha/pharia-engine/commit/32e9cc3053d16fbc89bd72815ce93c2861f4e39d))
* truncate large tool responses in message stream route ([0cbeec2](https://github.com/Aleph-Alpha/pharia-engine/commit/0cbeec250fca281773390f976813e248c57c3f00))
* use completion-params-v2 for completion-request ([baea817](https://github.com/Aleph-Alpha/pharia-engine/commit/baea817c146763ce47a79ac204ab2bc568105f82))
* user decides between max-tokens and max-completion-tokens ([7fa92ff](https://github.com/Aleph-Alpha/pharia-engine/commit/7fa92ffa8eec3f11cafcc9b1070c642723165f0e))


### Bug Fixes

* add default divisor: 1 for resource field references ([#696](https://github.com/Aleph-Alpha/pharia-engine/issues/696)) ([ed3f659](https://github.com/Aleph-Alpha/pharia-engine/commit/ed3f659153b0d2180f0e3de0b80a8919168db666))
* allow empty choice stream chunk to be compatible with GitHub models ([4ea4769](https://github.com/Aleph-Alpha/pharia-engine/commit/4ea47698bb4182c08520f9456954acc3b146cb39))
* bump wit version which was missed before ([8a6dd06](https://github.com/Aleph-Alpha/pharia-engine/commit/8a6dd06732b755c3208534dad4ac31cd2a4f3099))
* do not block message queue of mcp actor ([f8ee81f](https://github.com/Aleph-Alpha/pharia-engine/commit/f8ee81fe9521f35a475b5f4e98da030e46f96169))
* error message when listing tools in non-existing namespace ([56666a2](https://github.com/Aleph-Alpha/pharia-engine/commit/56666a28312d12b8def186bdd0ef8d5cc5828f8c))
...
* map wasm assistant message to correct inference message variant ([761b34c](https://github.com/Aleph-Alpha/pharia-engine/commit/761b34c67389131bde8207478e8125098e93b4ed))
* native tools and mcp servers are configured in kebab-case ([95bc0af](https://github.com/Aleph-Alpha/pharia-engine/commit/95bc0afd611140f0150e47c1bfa6c549bc7e9ed8))
* notify tool box about all namespaces ([a722280](https://github.com/Aleph-Alpha/pharia-engine/commit/a7222802381cbf1685b1d056177d09c8fd7a277c))
* only schedule special tool update if server is new ([88fcb6a](https://github.com/Aleph-Alpha/pharia-engine/commit/88fcb6ab4f46e2ad4dc595a53fbfd2b87e54143b))
* remove unneeded since gates on 0.4 wit world ([fbaa64c](https://github.com/Aleph-Alpha/pharia-engine/commit/fbaa64c5496d580c7ae9ffc2cdd4c563e4083186))
* remove unused allow dead code ([a3495d2](https://github.com/Aleph-Alpha/pharia-engine/commit/a3495d2be76f14d958c2af5d0a5e22f6014f1974))
* report updated tools if existing mcp server is configured for new namespace ([7e8c481](https://github.com/Aleph-Alpha/pharia-engine/commit/7e8c4811d709505b2e1a179e2be8a57ddf0475d1))
* return 404 when querying mcp-server list for non-existing namespace ([ea6f119](https://github.com/Aleph-Alpha/pharia-engine/commit/ea6f119e0227ce157cf8e8b339d631e8cf4050e0))
* server sent events can span multiple http chunks ([aedec1c](https://github.com/Aleph-Alpha/pharia-engine/commit/aedec1c8671efa30494fa184d6824b5d497b694a))
* set max_completion_tokens for reasoning models instead of max_tokens ([b638a54](https://github.com/Aleph-Alpha/pharia-engine/commit/b638a540f3b665cf1fecfccf21b52dc356bc80a7))
* tool box can report error if namespace does not exist ([5119e8f](https://github.com/Aleph-Alpha/pharia-engine/commit/5119e8f536ed5cb240976d6502892fb1d70bb75d))
* tool call events can contain role and content ([4cdc293](https://github.com/Aleph-Alpha/pharia-engine/commit/4cdc29331736b6519921460a288d1003583901fb))
* tool caller sends arguments as json integers ([16178bb](https://github.com/Aleph-Alpha/pharia-engine/commit/16178bb78fc682ff72c8000275dd01e06b85bf04))


### Performance Improvements

* Cached mcp servers are used in tool invocations ([55b728b](https://github.com/Aleph-Alpha/pharia-engine/commit/55b728b909824bc2f422f62b11be16152ea20626))
