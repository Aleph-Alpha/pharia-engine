...
impl SkillConfiguration {
    ...
    fn upsert_skill(&mut self, skill: ConfiguredSkill) -> bool {
    ...
    fn remove_skill(&mut self, skill_path: &SkillPath) -> bool {
...
pub mod tests {
    ...
    async fn skills_are_sorted() {
        ...
        skill_store
            ...
            .await;
        skill_store
            .upsert(ConfiguredSkill::new("b", "a", "latest"))
            .await;
        skill_store
    ...
    async fn should_only_cache_skills_that_have_been_fetched() {
        ...
        let skill = ConfiguredSkill::from_path(&SkillPath::new("local", "greet-py-v0_2"));
        skill_store.api().upsert(skill).await;
